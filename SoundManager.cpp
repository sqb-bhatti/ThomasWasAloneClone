...
SoundManager::SoundManager() {
    ...
    // Loop all the fire sounds when they are played. Now, when we call play, they will play continuously.
...
void SoundManager::playFallInFire() {
    // so that the sound effect is not spatialized, making the sound effect "normal", not directional
